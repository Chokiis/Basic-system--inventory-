    ...
    <!-- Código de navegador superior (botones y barra de búsqueda)-->
        ...
        <div class="container mt-5">
            <table class="table table-hover table-dark">
                <thead>
                    <tr>
                        <th scope="col" class="colu">Usuario</th>
                        <th scope="col" class="colu">Contraseña</th>
                        <th scope="col" class="colu">Perfil</th>
                        ...
                        while($arrUsu= mysqli_fetch_array($rsUsu)){
                            ...
                            echo "
                                <tr>
                                    ...
                                    <td>". $arrUsu['Pass'] ."</td>
                                    <td>". $arrUsu['Perfil'] ."</td>
                                    <td> <a href='confirmElim.php?idR=".$arrUsu['idUsuario']."&usuR=".$arrUsu['Usuario']."'><img src=imagenes/delete.png class='ima'></a> </td>
                                </tr>
                             ";
                        }
                    ?>
