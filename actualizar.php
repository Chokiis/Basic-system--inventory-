...
<html>
  <head>
    <meta charset="utf-8">
    <title>Actualización de juego</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <h1 class="display-3 text-center mt-5"> Actualizar videojuego: <?php echo $_REQUEST['VJu'];?></h1>
        ...
        <form class="contenedorform mt-5" action="controlador.php"  method="POST" onsubmit="return vaciosJuego()">
            <div class="form-row ">
                <div class="form-group col-md-6">
                    ...
                    <input type="hidden" class="form-control form-control-sm " name="txtIdActVJ" value="<?php echo $_REQUEST['idViJ'];?>">
                    <input type="text" class="form-control" name="txtModJuego" id="txtjuego" value="<?php echo $_REQUEST['VJu'];?>">
                </div>
                <div class="form-group col-md-6">
                    <label >Consola:</label>
                    <input type="text" class="form-control" name="txtModConsola" id="txtconsola" value="<?php echo $_REQUEST['ConsVJ'];?>">
                </div>
            </div>
            <div class="form-group">
                <label >Precio de adquisición:</label>
                <input type="text" class="form-control" name="txtModAdqui" id="txtadquisicion" value="<?php echo $_REQUEST['AdqJV'];?>">
            </div>
            <div class="form-group">
                <label >Precio de venta:</label>
                <input type="text" class="form-control" name="txtModVenta" id="txtventa" value="<?php echo $_REQUEST['VenVJ'];?>">
            </div>
          <button type="submit" name="btnActJuego" class="btn btn-success btn-block mt-2">Actualizar videojuego</button>
          <button type="submit" name="btnDesc" class="btn btn-danger btn-block mt-2">Descartar</button>
        </form>
    </div>
