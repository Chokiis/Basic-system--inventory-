...
<html>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <h1 class="display-3 text-center mt-5"> Registro de Usuarios</h1>

    <div class="container mt-2">
        <form class="contenedorform mt-5" action="controlador.php"  method="POST" onsubmit="return vaciosUsu()">
          ...
          <div class="form-group">
            <label> Perfil:</label>
            <select class="form-control" name="selperfil" id="selperfil">
              <option selected disabled >Elije...</option>
              <option >Empleado</option>
              <option>Administrador</option>
            </select>
          </div>
          <button type="submit" name="btnGusuario" class="btn btn-dark btn-block">Guardar Usuario</button>
        </form>
      </div>
